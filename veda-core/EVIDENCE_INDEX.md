...
are now entered. The register runs **R1..R74 with no gaps** -- a claim that was false when it said R1..R59: R57 had no entry at all, and the audit that produced this line did not re-run itself. Re-audited 2026-08-19 by extracting every `### Rn` heading and diffing the sequence.
