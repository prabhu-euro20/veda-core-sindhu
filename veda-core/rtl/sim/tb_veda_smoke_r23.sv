...
// x12 -- Perms of a plain Bind to object 1 BEFORE it is cow. Expect 0x103C
//        (Permit_Load | Permit_Store | Permit_NMC_Compute). Anchors x13.
// x13 -- Perms after set.cow + REBIND. Expect 0x1034 -- bit 3 (Permit_Store)
//        cleared by the 16'hFFF7 mask the Rebind arm was missing. Under the
//        old code this reads 0x103C, i.e. rebinding handed store back.
...
module tb;
  ...
  initial begin
    ...
    $display("B: perms_before_cow=0x%0h (want 0x103C)   perms_after_cow_REBIND=0x%0h (want 0x1034, bit 3 stripped)",
    ...
    if (dut.CPU_Xreg_val_a0[10] == 64'h41   &&
        ...
        dut.CPU_Xreg_val_a0[12] == 64'h103C &&
        dut.CPU_Xreg_val_a0[13] == 64'h1034 &&
