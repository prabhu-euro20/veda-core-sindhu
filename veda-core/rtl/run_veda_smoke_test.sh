...
vvp "$SIM/sim.vvp" +veda_fixtures +elf_hex="$SIM/veda_smoke_test.hex"
...
vvp "$SIM/sim_neg.vvp" +veda_fixtures +elf_hex="$SIM/veda_smoke_neg.hex"
...
vvp "$SIM/sim_m2.vvp" +veda_fixtures +elf_hex="$SIM/veda_smoke_m2.hex"
...
vvp "$SIM/sim_m2neg.vvp" +veda_fixtures +elf_hex="$SIM/veda_smoke_m2_neg.hex"
...
vvp "$SIM/sim_ocaneg.vvp" +veda_fixtures +elf_hex="$SIM/veda_smoke_oca_neg.hex"
...
vvp "$SIM/sim_m3.vvp" +veda_fixtures +elf_hex="$SIM/veda_smoke_m3.hex"
...
vvp "$SIM/sim_csbneg.vvp" +veda_fixtures +elf_hex="$SIM/veda_smoke_csetbounds_neg.hex"
...
vvp "$SIM/sim_m4.vvp" +veda_fixtures +elf_hex="$SIM/veda_smoke_m4.hex"
...
vvp "$SIM/sim_m4neg.vvp" +veda_fixtures +elf_hex="$SIM/veda_smoke_m4_neg.hex"
...
vvp "$SIM/sim_m5.vvp" +veda_fixtures +elf_hex="$SIM/veda_smoke_m5.hex"
...
vvp "$SIM/sim_m6.vvp" +veda_fixtures +elf_hex="$SIM/veda_smoke_m6.hex"
...
vvp "$SIM/sim_m7.vvp" +veda_fixtures +elf_hex="$SIM/veda_smoke_m7.hex"
...
vvp "$SIM/sim_m8.vvp" +veda_fixtures +elf_hex="$SIM/veda_smoke_m8.hex"
...
vvp "$SIM/sim_m8neg.vvp" +veda_fixtures +elf_hex="$SIM/veda_smoke_m8_neg.hex"
...
vvp "$SIM/sim_m9.vvp" +veda_fixtures +elf_hex="$SIM/veda_smoke_m9.hex"
...
vvp "$SIM/sim_m10.vvp" +veda_fixtures +elf_hex="$SIM/veda_smoke_m10.hex"
...
vvp "$SIM/sim_m10neg.vvp" +veda_fixtures +elf_hex="$SIM/veda_smoke_m10_neg.hex"
...
vvp "$SIM/sim_m11.vvp" +veda_fixtures +elf_hex="$SIM/veda_smoke_m11.hex"
...
vvp "$SIM/sim_m11neg.vvp" +veda_fixtures +elf_hex="$SIM/veda_smoke_m11_neg.hex"
...
vvp "$SIM/sim_m12.vvp" +veda_fixtures +elf_hex="$SIM/veda_smoke_m12.hex"
...
vvp "$SIM/sim_m12neg.vvp" +veda_fixtures +elf_hex="$SIM/veda_smoke_m12_neg.hex"
...
vvp "$SIM/sim_m13neg.vvp" +veda_fixtures +elf_hex="$SIM/veda_smoke_m13_neg.hex"
...
vvp "$SIM/sim_m14.vvp" +veda_fixtures +elf_hex="$SIM/veda_smoke_m14.hex"
...
vvp "$SIM/sim_m14neg.vvp" +veda_fixtures +elf_hex="$SIM/veda_smoke_m14_neg.hex"
...
vvp "$SIM/sim_m18.vvp" +veda_fixtures +elf_hex="$SIM/veda_smoke_m18.hex"
...
vvp "$SIM/sim_m18neg.vvp" +veda_fixtures +elf_hex="$SIM/veda_smoke_m18_neg.hex"
...
vvp "$SIM/sim_m19.vvp" +veda_fixtures +elf_hex="$SIM/veda_smoke_m19.hex"
...
vvp "$SIM/sim_m19neg.vvp" +veda_fixtures +elf_hex="$SIM/veda_smoke_m19_neg.hex"
...
vvp "$SIM/sim_m19neg2.vvp" +veda_fixtures +elf_hex="$SIM/veda_smoke_m19_neg2.hex"
...
vvp "$SIM/sim_m20.vvp" +veda_fixtures +elf_hex="$SIM/veda_smoke_m20.hex"
...
vvp "$SIM/sim_m20neg.vvp" +veda_fixtures +elf_hex="$SIM/veda_smoke_m20_neg.hex"
...
vvp "$SIM/sim_m20neg2.vvp" +veda_fixtures +elf_hex="$SIM/veda_smoke_m20_neg2.hex"
...
vvp "$SIM/sim_aqrl.vvp" +veda_fixtures +elf_hex="$SIM/veda_smoke_aqrl_invariance.hex"
...
vvp "$SIM/sim_m22.vvp" +veda_fixtures +elf_hex="$SIM/veda_smoke_m22.hex"
...
vvp "$SIM/sim_mosA_tsc.vvp" +veda_fixtures +elf_hex="$SIM/veda_smoke_mosA_tsc.hex"
...
vvp "$SIM/sim_mosB_sentry.vvp" +veda_fixtures +elf_hex="$SIM/veda_smoke_mosB_sentry.hex"
...
vvp "$SIM/sim_mosB_sentry_neg.vvp" +veda_fixtures +elf_hex="$SIM/veda_smoke_mosB_sentry_neg.hex"
...
vvp "$SIM/sim_m23_ecall.vvp" +veda_fixtures +elf_hex="$SIM/veda_smoke_m23_ecall.hex"
...
vvp "$SIM/sim_m23_ecall_compartment.vvp" +veda_fixtures +elf_hex="$SIM/veda_smoke_m23_ecall_compartment.hex"
...
vvp "$SIM/sim_m23_scheduler.vvp" +veda_fixtures +elf_hex="$SIM/veda_smoke_m23_scheduler.hex"
...
vvp "$SIM/sim_ssc_roundtrip.vvp" +veda_fixtures +elf_hex="$SIM/veda_smoke_ssc_roundtrip.hex"
...
vvp "$SIM/sim_ssc_ocinvoke_clear.vvp" +veda_fixtures +elf_hex="$SIM/veda_smoke_ssc_ocinvoke_clear.hex"
...
vvp "$SIM/sim_ssc_spill_reload.vvp" +veda_fixtures +elf_hex="$SIM/veda_smoke_ssc_spill_reload.hex"
...
vvp "$SIM/sim_ssc_oob.vvp" +veda_fixtures +elf_hex="$SIM/veda_smoke_ssc_oob.hex"
...
vvp "$SIM/sim_ssc_cross_thread.vvp" +veda_fixtures +elf_hex="$SIM/veda_smoke_ssc_cross_thread.hex"
...
vvp "$SIM/sim_m24lat.vvp" +veda_fixtures +elf_hex="$SIM/veda_smoke_m24_latency.hex"
...
vvp "$SIM/sim_m24odttcm.vvp" +veda_fixtures +elf_hex="$SIM/veda_smoke_m24_odt_tcm.hex"
...
vvp "$SIM/sim_m24ocsctcm.vvp" +veda_fixtures +elf_hex="$SIM/veda_smoke_m24_ocsc_tcm.hex"
...
vvp "$SIM/sim_pcc_restore.vvp" +veda_fixtures +elf_hex="$SIM/veda_smoke_pcc_restore_on_mret.hex"
...
vvp "$SIM/sim_mtvec_neg.vvp" +veda_fixtures +elf_hex="$SIM/veda_smoke_mtvec_escape_neg.hex"
...
vvp "$SIM/sim_s0k.vvp" +veda_fixtures +elf_hex="$SIM/veda_smoke_syscall0_kernel.hex"
...
vvp "$SIM/sim_s0kneg.vvp" +veda_fixtures +elf_hex="$SIM/veda_smoke_syscall0_kernel_forged_neg.hex"
...
vvp "$SIM/sim_granule_tamper.vvp" +veda_fixtures +elf_hex="$SIM/veda_smoke_cap_granule_tamper.hex"
...
vvp "$SIM/sim_misaligned.vvp" +veda_fixtures +elf_hex="$SIM/veda_smoke_cap_misaligned_neg.hex"
...
vvp "$SIM/sim_candperm.vvp" +veda_fixtures +elf_hex="$SIM/veda_smoke_candperm.hex"
...
vvp "$SIM/sim_candperm_neg.vvp" +veda_fixtures +elf_hex="$SIM/veda_smoke_candperm_neg.hex"
...
vvp "$SIM/sim_cap256.vvp" +veda_fixtures +elf_hex="$SIM/veda_smoke_cap256_roundtrip.hex"
...
vvp "$SIM/sim_region_unique.vvp" +veda_fixtures +elf_hex="$SIM/veda_smoke_region_unique.hex"
...
vvp "$SIM/sim_region_fastpath.vvp" +veda_fixtures +elf_hex="$SIM/veda_smoke_region_fastpath.hex"
...
vvp "$SIM/sim_region_fault_neg.vvp" +veda_fixtures +elf_hex="$SIM/veda_smoke_region_fault_neg.hex"
...
vvp "$SIM/sim_region_fault_modes_neg.vvp" +veda_fixtures +elf_hex="$SIM/veda_smoke_region_fault_modes_neg.hex"
...
vvp "$SIM/sim_r10_roundtrip.vvp" +veda_fixtures +elf_hex="$SIM/veda_smoke_r10_crbr_roundtrip.hex"
...
vvp "$SIM/sim_r10_fault_neg.vvp" +veda_fixtures +elf_hex="$SIM/veda_smoke_r10_crossing_fault_neg.hex"
...
vvp "$SIM/sim_residency.vvp" +veda_fixtures +elf_hex="$SIM/veda_smoke_residency.hex"
...
vvp "$SIM/sim_residency_order_neg.vvp" +veda_fixtures +elf_hex="$SIM/veda_smoke_residency_order_neg.hex"
...
vvp "$SIM/sim_residency_deref_neg.vvp" +veda_fixtures +elf_hex="$SIM/veda_smoke_residency_deref_neg.hex"
...
vvp "$SIM/sim_paging.vvp" +veda_fixtures +elf_hex="$SIM/veda_smoke_paging.hex"
...
vvp "$SIM/sim_paging_refusals_neg.vvp" +veda_fixtures +elf_hex="$SIM/veda_smoke_paging_refusals_neg.hex"
...
vvp "$SIM/sim_r11_crossing_neg.vvp" +veda_fixtures +elf_hex="$SIM/veda_smoke_r11_crossing_neg.hex"
...
vvp "$SIM/sim_r26.vvp" +veda_fixtures +elf_hex="$SIM/veda_smoke_r26_authority.hex"
...
vvp "$SIM/sim_r27.vvp" +veda_fixtures +elf_hex="$SIM/veda_smoke_r27_csr_priv.hex"
...
vvp "$SIM/sim_pca.vvp" +veda_fixtures +elf_hex="$SIM/veda_smoke_perm_cow_align.hex"
...
vvp "$SIM/sim_guards.vvp" +veda_fixtures +elf_hex="$SIM/veda_smoke_deref_guards.hex"
...
vvp "$SIM/sim_uaf.vvp" +veda_fixtures +elf_hex="$SIM/veda_smoke_uaf.hex"
...
vvp "$SIM/sim_chkorder.vvp" +veda_fixtures +elf_hex="$SIM/veda_smoke_check_order.hex"
...
vvp "$SIM/sim_r23.vvp" +veda_fixtures +elf_hex="$SIM/veda_smoke_r23.hex"
...
vvp "$SIM/sim_cow_repair.vvp" +veda_fixtures +elf_hex="$SIM/veda_smoke_cow_repair.hex"
...
vvp "$SIM/sim_cow_fault.vvp" +veda_fixtures +elf_hex="$SIM/veda_smoke_cow_fault.hex"
...
vvp "$SIM/sim_bind_domain_neg.vvp" +veda_fixtures +elf_hex="$SIM/veda_smoke_bind_domain_neg.hex"
...
vvp "$SIM/sim_odt_set_domain.vvp" +veda_fixtures +elf_hex="$SIM/veda_smoke_odt_set_domain.hex"
...
vvp "$SIM/sim_bounds_wrap_neg.vvp" +veda_fixtures +elf_hex="$SIM/veda_smoke_bounds_wrap_neg.hex"
...
vvp "$SIM/sim_bind_leak_neg.vvp" +veda_fixtures +elf_hex="$SIM/veda_smoke_bind_leak_neg.hex"
...
vvp "$SIM/sim_perm_enforce_neg.vvp" +veda_fixtures +elf_hex="$SIM/veda_smoke_perm_enforce_neg.hex"
...
vvp "$SIM/sim_r13_alias_destroy_neg.vvp" +veda_fixtures +elf_hex="$SIM/veda_smoke_r13_alias_destroy_neg.hex"
...
vvp "$SIM/sim_r11b_pin.vvp" +veda_fixtures +elf_hex="$SIM/veda_smoke_r11b_pin.hex"
...
vvp "$SIM/sim_r12_poison.vvp" +veda_fixtures +elf_hex="$SIM/veda_smoke_r12_poison.hex"
...
vvp "$SIM/sim_base.vvp" +veda_fixtures
